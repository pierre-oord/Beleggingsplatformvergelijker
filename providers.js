...
(() => {
  ...
  const PROVIDERS = [
    ...
    },
    {
      ...
      fbi: false,
      risk_indicator: null,
      dividend: null, // Onduidelijk, afgaande op letter na namen fondsen waar het heen gaat lijkt het beide) https://www.keytradebank.be/nl/investeren/keyplan/creeer-uw-beleggingsplan?initialAmount=0&recurringAmount=25&periodicity=2&selectedProfile=A
      tax_BE_TOB_service: 'Ja',
      tax_BE_roerende_voorheffing_service: 'Ja',
      tax_BE_roerende_voorheffing_percentage: null,
      tax_BE_effectentaks_service: "",
